...
class posterior():
    ...
    def _get_cl_all(self, cosmo, pk):
        """ Compute all C_ells."""
        # Gather all tracers
        trs = self._get_tracers(cosmo)
    ...
    def get_cls_theory(self,CCL_cosmo):
    ...
    def _get_theory(self,CCL_cosmo):
        """ Computes theory vector."""
        cls = self.get_cls_theory(CCL_cosmo)
    ...
    def logp(self,CCL_cosmo = None):
        """
        Simple Gaussian likelihood.
        """
        t = self._get_theory(CCL_cosmo)
        r = t - self.data_vec
